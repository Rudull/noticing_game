...
window.UIManager = (function () {
    ...
    function createFloatingPanel() {
        ...
        header.className =
            "noticing-game-header noticing-game-draggable-header";
  ...
  <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
        ...
        const analyzeBtn = UI.createButton(
        ...
        WLM.loadWordListConfig().then(() => {
          ...
          <div class="noticing-game-about-content">
              ...
              <ol style="padding-left: 20px;">
                  ...
                  <li>You get points for correctly noticing words. Be careful! You'll lose points if you click words that haven't appeared recently</li>
        ...
        setTimeout(() => {
            ...
            if (deleteButton) {
                deleteButton.addEventListener("click", function () {
                    const listSelector =
                        panel.querySelector("#word-list-select");
                    if (listSelector && listSelector.value) {
                        const selectedListId = listSelector.value;
                        const selectedListName =
                            listSelector.options[listSelector.selectedIndex]
                                .text;
            ...
            const closeAboutBtn = panel.querySelector(
    ...
    function displayWords(words, contentElement, statusElement) {
        ...
        if (words.length === 0) {
            wordList.textContent =
                "No words from the list were found in this video.";
            return;
        }
